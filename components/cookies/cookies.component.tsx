...
const CookiesComponent = () => {
  return (
    <div className="container mt-5 mb-5">
      ...
      <h2 className="h2 mt-5">1. Informacje ogólne</h2>
      <p>
        Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url:
        mediaHunters.pl Operatorem serwisu oraz Administratorem danych osobowych
        jest: mediahunters przejazdowa 21 51-167 Adres kontaktowy poczty
        elektronicznej operatora: hello.mediahunters@gmail.com Operator jest
        Administratorem Twoich danych osobowych w odniesieniu do danych podanych
        dobrowolnie w Serwisie. Serwis wykorzystuje dane osobowe w następujących
        celach:
      </p>

      <ul className="list-unstyled mt-3 mb-5 text-left">
        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Obsługa zapytań
          przez formularz
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Realizacja
          zamówionych usług
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Prezentacja
      ...
      <p>
        ...
        okresowo zmienia swoje hasła administracyjne. Istotnym elementem ochrony
      ...
      <h2 className="h2 mt-5">3. Hosting</h2>
      <p>
      ...
      <ul className="list-unstyled mt-3 mb-5 text-left">
        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> firma hostingowa
          na zasadzie powierzenia
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> operatorzy
          pocztowi
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> upoważnieni
      ...
      <ul className="list-unstyled mt-3 mb-5 text-left">
        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> dostępu do
          danych osobowych Ciebie dotyczących,
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> ich
          sprostowania,
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> usunięcia,
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> ograniczenia
          przetwarzania,
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> oraz
          przenoszenia danych.
        </li>
      </ul>
      ...
      <p>
        ...
        Danych Osobowych, ul. Stawki 2, 00-193 Warszawa. Podanie danych
        osobowych jest dobrowolne, lecz niezbędne do obsługi Serwisu. W stosunku
      ...
      <h2 className="h2 mt-5">5. Informacje w formularzach</h2>
      <p>
      ...
      <h2 className="h2 mt-5">6. Logi Administratora</h2>
      <p>
      ...
      <h2 className="h2 mt-5">7. Istotne techniki marketingowe</h2>
      ...
      <h2 className="h2 mt-5">8. Informacja o plikach cookies</h2>
      ...
      <p>
        ...
        Użytkownika. Oprogramowanie do przeglądania stron internetowych
        (przeglądarka internetowa) zazwyczaj domyślnie dopuszcza przechowywanie
        plików cookies w urządzeniu końcowym Użytkownika. Użytkownicy Serwisu
        mogą dokonać zmiany ustawień w tym zakresie. Przeglądarka internetowa
        ...
        pomoc lub dokumentacja przeglądarki internetowej. Ograniczenia
        stosowania plików cookies mogą wpłynąć na niektóre funkcjonalności
        dostępne na stronach internetowych Serwisu. Pliki cookies zamieszczane w
      ...
      <ul className="list-unstyled mt-3 mb-5 text-left">
        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Edge
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Internet
          Explorer
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Chrome
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Safari
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Firefox
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Opera
        </li>
      </ul>
      ...
      <ul className="list-unstyled mt-3 text-left">
        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Android
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Safari (iOS)
        </li>

        <li className="mb-3">
          <AiOutlineCheck className="cr-primary-bittersweet" /> Windows Phone
        </li>
      </ul>
    </div>
  );
